...
class XXX_ShowFood extends StatefulWidget {
  // const test({Key key}) : super(key: key);
  var req_rid;
  XXX_ShowFood(this.req_rid);

  @override
  _XXX_ShowFoodState createState() => _XXX_ShowFoodState(req_rid);
}

class _XXX_ShowFoodState extends State<XXX_ShowFood> {
  var req_rid;
  _XXX_ShowFoodState(this.req_rid);
